...
복잡한 지도 검색 없이 맞춤형 코스를 자동으로 제안해 주는 국내 여행자를 위한 플랫폼입니다.  
버튼 한 번으로 모든 일정 생성이 가능하며, 가고 싶은 지역만 알려주시면 돼요!  
편리함과 즐거움을 동시에 잡은, 국내 여행의 든든한 동반자 **BackpacKOR**와 함께 지금 떠나보세요! 🚍✈️

---

## 📅 개발 기간
**2025.XX.XX ~ 2025.XX.XX** *(개발 기간을 입력해주세요)*

---

## 🔗 배포 링크
👉 [BackpacKOR 바로가기](#) *(Vercel 배포 링크를 입력해주세요)*

---

## 📄 프로젝트 발표자료
👉 [BackpacKOR 발표자료 보러가기](#) *(발표 자료 PDF 링크를 입력해주세요)*

---

## 🏆 프로젝트 성과
*(프로젝트 성과가 있다면 여기에 작성해주세요)*

---

## 📖 프로젝트 개요

**BackpacKOR**는 **배낭여행자(Backpacker)** 에서 영감을 받아 **Backpack**과 **Korea**를 합쳐 만든,  
국내 여행자를 위한 **맞춤형 여행 코스 추천 플랫폼**입니다.

복잡한 지도 검색과 일정 계획 없이, AI 기반 추천 시스템을 통해  
여행하고 싶은 지역만 입력하면 최적의 여행 코스를 자동으로 생성해줍니다.

사용자는 추천받은 여행지를 확인하고, 리뷰와 평점을 참고하며,  
나만의 여행 일정을 쉽게 구성할 수 있습니다.
...
### 1️⃣ AI 추천 고도화
- Gemini API를 활용한 더욱 정교한 일정 추천 알고리즘 개선
- 사용자 선호도 및 과거 데이터 기반 맞춤형 추천

### 2️⃣ 실시간 여행지 정보 업데이트
- 여행지 운영시간, 비용 등 실시간 정보 반영
- 외부 API 연동을 통한 최신 정보 제공

### 3️⃣ 해외 여행지 확장
- 국내 여행지뿐만 아니라 해외 주요 도시 정보 추가
- 다국어 지원 기능 도입

### 4️⃣ 모바일 앱 출시
- React Native 기반 모바일 앱 개발
- 오프라인 모드 및 푸시 알림 기능 추가
...
### 👍 긍정적인 피드백
*(발표 후 받은 긍정적인 피드백을 작성해주세요)*

예시:
- Git 커밋 컨벤션 및 PR 템플릿이 체계적으로 잘 구성됨
- AI 기반 일정 추천 기능이 독창적이고 실용적임
- 카카오맵 연동을 통한 시각화가 사용자 경험을 크게 향상시킴

### 🔍 개선 피드백
*(발표 후 받은 개선 제안을 작성해주세요)*

예시:
- 일부 페이지에서 로딩 시간이 길어 스켈레톤 UI 추가 필요
- 모바일 반응형 디자인 개선 필요
- 여행지 상세 페이지에서 더 많은 정보 제공 요청
...
| **장창용** | 풀스택 개발<br/>문서 오너 | 여행지 상세 페이지, 모달, 찜, 리뷰 도움 시스템 |
...
**🎒 BackpacKOR와 함께 국내 여행을 더 즐겁고 편리하게!**
