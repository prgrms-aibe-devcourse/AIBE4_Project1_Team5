 ...
 */
function AiPlannerSpeedContent() {
  ...
  const speedOptions = [
    {
      name: "느긋한 일정",
      value: "relaxed",
      description: "하루 평균 2~3개의 활동을 추천합니다.",
      icon: "🐢",
      color: "emerald",
    },
    {
      name: "보통",
      value: "normal",
      description: "하루 평균 4~5개의 활동을 추천합니다.",
      icon: "🚶",
      color: "blue",
    },
    {
      name: "꽉 찬 일정",
      value: "packed",
      description: "하루 평균 7~8개의 활동을 추천합니다.",
      icon: "🏃",
      color: "orange",
    },
  ];
