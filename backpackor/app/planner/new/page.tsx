      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            출발일과 도착일을 선택하면 여행 일정을 계획할 수 있어요
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {!tripInfo && (
              <div className="bg-gray-100 rounded-2xl p-6 text-center border-2 border-dashed border-gray-300">
                ...
                <p className="text-gray-500">여행 날짜를 선택해주세요</p>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              <style jsx global>{`
                ...
                .custom-calendar .rdp-nav_button:hover:not(:disabled) {
                  background: #f3f4f6;
                  border-color: #d1d5db;
                }
                .custom-calendar .rdp-nav_button:disabled {
                  opacity: 0.3;
                  cursor: not-allowed;
                }
                .custom-calendar .rdp-nav_button svg {
                  width: 18px;
                  height: 18px;
                }
